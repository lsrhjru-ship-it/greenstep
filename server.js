...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`\n=================================================`);
    console.log(` ✅ GreenStep 서버가 성공적으로 가동되었습니다.`);
    console.log(` 🌐 접속 주소: ${currentRunningUrl}`);
    console.log(`-------------------------------------------------`);

    // 2. 일회용 인증코드 강조
    console.log(` 🔑 관리자 로그인용 일회용 인증코드:`);
    console.log(`    >>>  ${tempMasterCode}  <<<`);
    console.log(` (※ 이 코드는 관리자 페이지 로그인 1회 후 자동 갱신됩니다)`);
    console.log(`=================================================\n`);
});
